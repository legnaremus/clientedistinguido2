...
app.controller('sucursalesCtrl',function($scope,servidor,token) {
	...
	$scope.guardar_cambios = function(){
		...
		if ($scope.contrasenia == ''){
			$scope.message_error = 'Escriba su contraseña';
			return;
		}
...
app.controller('menuCtrl',function($scope,$location,servidor,token,$window,$timeout){
	...
	$scope.items = [
	      ...
	      {path: '/home', title: 'Inicio', clase: 'fa fa-home fa-fw'},
	      {path: '/altas', title: 'Altas', clase: 'fa fa-arrow-circle-up fa-fw'},
	      {path: '/buscar', title: 'Buscar', clase: 'fa fa-search fa-fw'},
	      {path: '/registros', title: 'Registros', clase: 'fa fa-wpforms fa-fw'},
	      {path: '/usuarios', title: 'Usuarios', clase: 'fa fa-users fa-fw'},
	      {path: '/sucursales', title: 'Sucursales', clase: 'fa fa-cubes fa-fw'},
	      {path: '/promociones', title: 'Promociones', clase: 'fa fa-tags fa-fw'},
	      {path: '/configuraciones', title: 'Configuraciones', clase: 'fa fa-gears fa-fw'},
